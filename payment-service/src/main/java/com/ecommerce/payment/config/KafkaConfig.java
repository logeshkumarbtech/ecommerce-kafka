...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, StockReservedEvent> consumerFactory() {
        JsonDeserializer<StockReservedEvent> deserializer = new JsonDeserializer<>(StockReservedEvent.class, false);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, StockReservedEvent> kafkaListenerContainerFactory() {
